...
void SceneSpheres::init() {
    ...
    lm->addLight(glm::vec3(0.0f, 0.0f, -0.6f), glm::vec4(1.0, 1.0, 1.0, 1.0));

    // Sphere at the top center
    ShaderProgram* sphereTop_shaderProgram = new ShaderProgram(camera);
    sphereTop_shaderProgram->setLightManager(lm);
    sphereTop_shaderProgram->loadShader("VertexShaderPhongMultipleLights.glsl", "FragmentShaderPhongMultipleLights.glsl");
    ...
    sphereBottom_shaderProgram->setLightManager(lm);
    sphereBottom_shaderProgram->loadShader("VertexShaderPhongMultipleLights.glsl", "FragmentShaderPhongMultipleLights.glsl");
    ...
    sphereLeft_shaderProgram->setLightManager(lm);
    sphereLeft_shaderProgram->loadShader("VertexShaderPhongMultipleLights.glsl", "FragmentShaderPhongMultipleLights.glsl");
    ...
    sphereRight_shaderProgram->setLightManager(lm);
    sphereRight_shaderProgram->loadShader("VertexShaderPhongMultipleLights.glsl", "FragmentShaderPhongMultipleLights.glsl");
